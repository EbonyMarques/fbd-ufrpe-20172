...
ALTER TABLE partida ADD FOREIGN KEY(rg_arbitro) REFERENCES arbitro_principal (rg_arbitro) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE time_profissional ADD FOREIGN KEY(cod_diretor) REFERENCES diretor (cod_diretor) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE uniforme ADD FOREIGN KEY(cod_cor) REFERENCES cor(cod_cor) ON DELETE CASCADE ON UPDATE CASCADE;

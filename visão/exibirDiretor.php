    ...
    <nav class="navbar navbar-default">
      <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="exibirDiretor.php">Diretor</a></li>
                    ...
                    <td>
                        <div class='dropdown'>
                          ...
                          <ul class='dropdown-menu'>
                            <li id='dados'><a href='atualizar/atualizarDiretor.php?".$value["cod_diretor"]."'>Editar</a></li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="/fbd/controlador/diretor.php" method="post">
                    <div id="inputs">
                        <input type="hidden" class="form-control" name="cod_diretor">
